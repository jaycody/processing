...
/*using 238 images from the Angel Card Library used here as an array of images
 ...
 /*
 1.  what happens if you get each rectangle to rotate on its own, rather than  entire system?
...
//  //translate (x+10, y+10);
//  rotate(rot);
//  image(images[imageIndex3],10,10,mouseX,mouseY);//ORIGINAL 3
//  blend(images[imageIndex4], 10, 10, mouseX, mouseY, 0, 0, mouseX, mouseY, DIFFERENCE);
//  rectMode(NORMAL);
//  popMatrix();

 rectMode(CORNER);
 image(images[imageIndex3],10,10,mouseX*2,mouseY*2);//ORIGINAL 3
 //blend(images[imageIndex3], 10, 10, mouseX*2, mouseY*2, 0, 0, mouseX*2, mouseY*2, SOFT_LIGHT);

...
class GravityTriangle {
  ...
  float speedY2 = random(.5,2);
  float dampenX2 =random(-1.05,-1.15);
  float dampenY2 =random(-.99,-1.0);
  float gravity2 = random(.05,.09);
  ...
  float dampenX3 = random(-1.1,-1.15);
  float dampenY3=random(-.99,-1);
  float gravity3 = random(.04,.08);
